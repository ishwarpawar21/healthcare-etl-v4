...
# healthcare_etl_v4 documentation build
...
from healthcare_etl_v4 import __version__ as release

# -- Project information -----------------------------------------------------

project = "healthcare_etl_v4"
author = "Kedro"
...
htmlhelp_basename = "healthcare_etl_v4doc"
...
latex_documents = [
    (
        master_doc,
        "healthcare_etl_v4.tex",
        "healthcare_etl_v4 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "healthcare_etl_v4",
        "Project healthcare_etl_v4 codebase.",
        "Data-Science",
    )
]
